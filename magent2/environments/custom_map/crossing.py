...
class _parallel_env(magent_parallel_env, EzPickle):
    ...
    def generate_map(self):
        ...
        width = map_size # 80
        height = map_size # int(map_size * 3/4)  # 60
        # width // 2 + gap
        l_gap = 25
        r_gap = 2
        leftID, rightID = 0, 1
        ...
        # left
        wall_pos = []
        wall_pos += self.get_block_obstacles(10, 15, 10, 15)
        wall_pos += self.get_block_obstacles(10, 15, 45, 50)
        wall_pos += self.get_block_obstacles(20, 25, 25, 45)
        wall_pos += self.get_block_obstacles(55, 60, 15, 45)
        for y in range(1, 35):
            wall_pos.append((width / 2 - 5, y))
            wall_pos.append((width / 2 - 4, y))
        for y in range(40, height-1):
            wall_pos.append((width / 2 - 5, y))
            wall_pos.append((width / 2 - 4, y))

        for y in range(1 , 30):  # 1 -> 30
            wall_pos.append((width / 2 + 7, y))
            wall_pos.append((width / 2 + 6, y))

        for y in range(38                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      , height - 1): # 35 -> 59
            wall_pos.append((width / 2 + 7, y))
            wall_pos.append((width / 2 + 6, y))

        side = int(math.sqrt(4)) * 2
        for x in range(width // 2 + r_gap, 34 + r_gap + side, 2):
        ...
        # right
        pos = [
            [width-20 + np.random.randint(0, 10), 5 + np.random.randint(0, 10), 0]
        ]
